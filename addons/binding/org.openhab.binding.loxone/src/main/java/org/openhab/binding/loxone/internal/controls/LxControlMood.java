...
class LxControlMood extends LxControlSwitch {
     ...
     * @param moodId
     *            mood ID within the controller (received from the Miniserver)
     * @param isStatic
     *            true if this mood is static and can't be deleted or modified in any way
     * @param controller
     *            light controller that this mood belongs to
     */
    LxControlMood(LoxoneMiniserverHandlerApi handlerApi, LxUuid uuid, LxJsonControl json, LxContainer room,
            LxCategory category, Integer moodId, Boolean isStatic, LxControlLightControllerV2 controller) {
