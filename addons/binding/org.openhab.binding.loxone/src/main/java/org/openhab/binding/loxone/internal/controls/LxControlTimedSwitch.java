...
public class LxControlTimedSwitch extends LxControlPushbutton {
     ...
     */
    LxControlTimedSwitch(LoxoneMiniserverHandlerApi handlerApi, LxUuid uuid, LxJsonControl json, LxContainer room,
            LxCategory category) {
    ...
    public State getChannelState(ChannelUID channelId) {
        if (defaultChannelId.equals(channelId)) {
            ...
            Double deactivationValue = getStateValue(STATE_DEACTIVATION_DELAY);
