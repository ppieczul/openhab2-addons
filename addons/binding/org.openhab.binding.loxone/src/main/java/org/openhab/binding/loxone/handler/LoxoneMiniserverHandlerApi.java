...
public interface LoxoneMiniserverHandlerApi {
     ...
     *
     * @param channelId
     *            channel ID with the new state description
     * @param description
    ...
    /**
     * Adds a new control to the handler structures, plus its states and subcontrols
     ...
     *
     * @param control
     *            control to remove from server structures
     */
    void removeControl(LxControl control);

    /**
     * Sends an action to the Miniserver using current websocket connection.
     *
     * @param id
     *            identifier of the control sending the action
     * @param operation
     ...
     *            event to send
     * @return
     *         false when error sending event
     */
     ...
     *
     * @param settings
     *            map of setting name as a key and setting values
     */
