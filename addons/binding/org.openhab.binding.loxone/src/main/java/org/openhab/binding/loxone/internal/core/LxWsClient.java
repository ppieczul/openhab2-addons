...
public class LxWsClient {
    private final LoxoneMiniserverHandlerApi handlerApi;
     ...
     *             when host can't be resolved or reached
     */
    public LxWsClient(int debugId, LoxoneMiniserverHandlerApi handlerApi, LoxoneMiniserverConfig cfg)
            throws UnknownHostException {
